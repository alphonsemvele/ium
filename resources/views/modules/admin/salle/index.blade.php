    ...
    @volt
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <header class="mb-12 text-center">
                <h1 class="text-4xl font-bold text-gray-900 bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent tracking-tight">Gestion des Salles</h1>
                <p class="mt-3 text-lg text-gray-600">Créez, modifiez, supprimez des salles et associez-les à une filière et une spécialité.</p>
            </header>

            <!-- Formulaire Créer/Modifier Salle -->
            <div class="bg-white rounded-2xl shadow-lg p-8 mb-8">
                <h2 class="text-2xl font-semibold text-gray-800 mb-6">Ajouter ou Modifier une Salle</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label class="block text-sm font-medium text-gray-600">Nom de la Salle</label>
                        <input type="text" value="Amphithéâtre A" class="mt-1 w-full p-3 border border-gray-300 rounded-lg">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-600">Capacité</label>
                        <input type="number" value="100" class="mt-1 w-full p-3 border border-gray-300 rounded-lg">
                    </div>
                    <div>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-600">Équipements</label>
                        <input type="text" value="Projecteur, Wi-Fi, Tableaux" class="mt-1 w-full p-3 border border-gray-300 rounded-lg">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-600">Localisation</label>
                        <input type="text" value="Bâtiment A, Étage 1" class="mt-1 w-full p-3 border border-gray-300 rounded-lg">
                    </div>
                </div>
                    ...
                    <table class="w-full text-left border-separate border-spacing-y-2">
                        <thead>
                            <tr class="bg-gray-100 rounded-lg">
                                ...
                                <th class="p-4 text-sm font-medium text-gray-600">Équipements</th>
                                <th class="p-4 text-sm font-medium text-gray-600">Localisation</th>
                                <th class="p-4 text-sm font-medium text-gray-600">Actions</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="bg-gray-50 rounded-lg">
                                <td class="p-4">Amphithéâtre A</td>
                                <td class="p-4">100</td>
                                <td class="p-4">Informatique</td>
                                <td class="p-4">Développement Logiciel</td>
                                <td class="p-4">Projecteur, Wi-Fi, Tableaux</td>
                                <td class="p-4">Bâtiment A, Étage 1</td>
                                <td class="p-4">
                            ...
                            <tr class="bg-gray-50 rounded-lg">
                                ...
                                <td class="p-4">Ordinateurs, Wi-Fi</td>
                                <td class="p-4">Bâtiment B, Étage 2</td>
                                <td class="p-4">
                                    <a href="#" class="text-indigo-600 hover:underline">Modifier</a>
                                    <a href="#" class="text-red-600 hover:underline ml-2">Supprimer</a>
                                </td>
