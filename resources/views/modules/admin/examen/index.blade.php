    ...
    @volt
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <header class="mb-12 text-center">
                <h1 class="text-4xl font-bold text-gray-900 bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent tracking-tight">Gestion des Examens</h1>
                <p class="mt-3 text-lg text-gray-600">Créez, modifiez et gérez les examens avec date, filière et spécialité.</p>
            </header>

            <!-- Formulaire Créer/Modifier Examen -->
            <div class="bg-white rounded-2xl shadow-lg p-8 mb-8">
                <h2 class="text-2xl font-semibold text-gray-800 mb-6">Ajouter ou Modifier un Examen</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label class="block text-sm font-medium text-gray-600">Nom de l'Examen</label>
                        <input type="text" value="Examen Final Algorithmique" class="mt-1 w-full p-3 border border-gray-300 rounded-lg">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="date" value="2025-12-20" class="mt-1 w-full p-3 border border-gray-300 rounded-lg">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-600">Heure</label>
                        <input type="time" value="09:00" class="mt-1 w-full p-3 border border-gray-300 rounded-lg">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-600">Salle</label>
                    ...
                    <table class="w-full text-left border-separate border-spacing-y-2">
                        <thead>
                            <tr class="bg-gray-100 rounded-lg">
                                <th class="p-4 text-sm font-medium text-gray-600">Examen</th>
                        ...
                        <tbody>
                            <tr class="bg-gray-50 rounded-lg">
                                <td class="p-4">Examen Final Algorithmique</td>
                                <td class="p-4">Informatique</td>
                                <td class="p-4">Développement Logiciel</td>
                                <td class="p-4">20/12/2025 09:00</td>
                            ...
                            <tr class="bg-gray-50 rounded-lg">
                                <td class="p-4">Examen Sécurité des Systèmes</td>
                                <td class="p-4">Informatique</td>
                                <td class="p-4">Cybersécurité</td>
                                <td class="p-4">21/12/2025 14:00</td>
