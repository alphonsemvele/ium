...
<head>
    ...
    <meta name="description" content="L’École de Métier Ndazoa - Formations professionnelles bilingues">
    <meta name="keywords"
...
<body>
    ...
    <section class="space" id="about-sec" data-aos="fade-up" data-aos-duration="800">
        <div class="container">
            <div class="row flex-row-reverse align-items-center">
                ...
                <div class="col-xl-6" data-aos="fade-right" data-aos-delay="200">
                    <div class="title-area mb-35">
                        ...
                        <h2 class="sec-title fw-semibold">INSTITUT SUPERIEUR LA MAJESTUEUSE</h2>
                    </div>
                    <p class="mt-n2 mb-35">L’Institut Supérieur Majestueuse est un établissement d’enseignement
                        supérieur pluridisciplinaire dédié à la formation de professionnels hautement qualifiés. Grâce à
                        une pédagogie innovante, un corps professoral expérimenté et des partenariats avec le monde
                        professionnel, nous préparons nos étudiants à relever les défis d’un marché du travail en pleine
                        évolution, en leur offrant les outils d’une carrière compétente et accomplie.</p>
                    ...
                    <div class="list-column2 mb-45">
                        <div class="checklist style4">
                            <ul>
                                <li>Formations pratiques et bilingues</li>
                        ...
                        <div class="checklist style4">
                            <ul>
                                ...
                                <li>Partenariats avec des entreprises locales</li>
                            </ul>
                        </div>
                    </div>
    ...
    <section class="space bg-smoke" id="course-sec" data-aos="fade-up" data-aos-duration="800">
        <div class="container">
            ...
            <div class="row gy-4">
                <div class="col-md-6 col-xl-4" data-aos="zoom-in" data-aos-delay="100">
                    <div class="admission-card">
                        <div class="admission-card_img"><img
                                src="{{ asset('asset_vitrine/assets/img/update1/normal/admission_1_1.jpg') }}"
                                alt="image"></div>
                        <div class="admission-card_content">
                            <h3 class="admission-card_title box-title">Mécanique automobile</h3>
                            <p class="admission-card_text">Apprenez à diagnostiquer, réparer et entretenir des
                                véhicules avec des équipements modernes et des formateurs qualifiés.</p>
                            <a href="#" class="link-btn register-btn"
                                data-filiere="Mécanique automobile">S'inscrire maintenant<i
                                    class="fas fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-4" data-aos="zoom-in" data-aos-delay="200">
                    <div class="admission-card">
                        <div class="admission-card_img"><img
                                src="{{ asset('asset_vitrine/assets/img/update1/normal/admission_1_2.jpg') }}"
                                alt="image"></div>
                        <div class="admission-card_content">
                            <h3 class="admission-card_title box-title">Hôtellerie et Restauration</h3>
                            <p class="admission-card_text">Maîtrisez les techniques de service, de cuisine et de
                                gestion hôtelière pour exceller dans l'industrie du tourisme.</p>
                            <a href="#" class="link-btn register-btn"
                                data-filiere="Hôtellerie et Restauration">S'inscrire maintenant<i
                                    class="fas fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-4" data-aos="zoom-in" data-aos-delay="300">
                    <div class="admission-card">
                        <div class="admission-card_img"><img
                                src="{{ asset('asset_vitrine/assets/img/update1/normal/admission_1_3.jpg') }}"
                                alt="image"></div>
                        <div class="admission-card_content">
                            <h3 class="admission-card_title box-title">Informatique et Réseaux</h3>
                            <p class="admission-card_text">Développez des compétences en programmation, maintenance et
                                gestion de réseaux pour une carrière dans la technologie.</p>
                            <a href="#" class="link-btn register-btn"
                                data-filiere="Informatique et Réseaux">S'inscrire maintenant<i
                                    class="fas fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-4" data-aos="zoom-in" data-aos-delay="300">
                    <div class="admission-card">
                        <div class="admission-card_img"><img
                                src="{{ asset('asset_vitrine/assets/img/update1/normal/admission_1_4.jpg') }}"
                                alt="image"></div>
                        <div class="admission-card_content">
                            <h3 class="admission-card_title box-title">Médico Sanitaire</h3>
                            <p class="admission-card_text">Formez-vous aux soins de santé de base, à l'assistance
                                médicale et à la gestion des urgences sanitaires.</p>
                            <a href="#" class="link-btn register-btn"
                                data-filiere="Médico Sanitaire">S'inscrire maintenant<i
                                    class="fas fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-4" data-aos="zoom-in" data-aos-delay="300">
                    <div class="admission-card">
                        <div class="admission-card_img"><img
                                src="{{ asset('asset_vitrine/assets/img/update1/normal/admission_1_5.jpg') }}"
                                alt="image"></div>
                        <div class="admission-card_content">
                            <h3 class="admission-card_title box-title">Sécurité incendie</h3>
                            <p class="admission-card_text">Acquérez des compétences en prévention, gestion des
                                incendies et sécurité pour protéger des vies et des biens.</p>
                            <a href="#" class="link-btn register-btn"
                                data-filiere="Sécurité incendie">S'inscrire maintenant<i
                                    class="fas fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-4" data-aos="zoom-in" data-aos-delay="300">
                    <div class="admission-card">
                        <div class="admission-card_img"><img
                                src="{{ asset('asset_vitrine/assets/img/update1/normal/admission_1_6.jpg') }}"
                                alt="image"></div>
                        <div class="admission-card_content">
                            <h3 class="admission-card_title box-title">Bâtiment et génie civil</h3>
                            <p class="admission-card_text">Apprenez les techniques de construction, de conception et de
                                gestion de projets dans le secteur du bâtiment.</p>
                            <a href="#" class="link-btn register-btn"
                                data-filiere="Bâtiment et génie civil">S'inscrire maintenant<i
                                    class="fas fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-4" data-aos="zoom-in" data-aos-delay="300">
                    <div class="admission-card">
                        <div class="admission-card_img"><img
                                src="{{ asset('asset_vitrine/assets/img/update1/normal/admission_1_7.jpg') }}"
                                alt="image"></div>
                        <div class="admission-card_content">
                            <h3 class="admission-card_title box-title">Audio visuel</h3>
                            <p class="admission-card_text">Maîtrisez la production, le montage et la réalisation de
                                contenus audiovisuels pour le cinéma et les médias.</p>
                            <a href="#" class="link-btn register-btn" data-filiere="Audio visuel">S'inscrire
                ...
                <div class="col-md-6 col-xl-4" data-aos="zoom-in" data-aos-delay="300">
                    <div class="admission-card">
                        <div class="admission-card_img"><img
                                src="{{ asset('asset_vitrine/assets/img/update1/normal/admission_1_8.jpg') }}"
                                alt="image"></div>
                        <div class="admission-card_content">
                            <h3 class="admission-card_title box-title">Industrie de l'Habillement</h3>
                            <p class="admission-card_text">Formez-vous à la conception, à la couture et à la production
                                de vêtements pour l'industrie de la mode.</p>
                            <a href="#" class="link-btn register-btn"
                                data-filiere="Industrie de l'Habillement">S'inscrire maintenant<i
                                    class="fas fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-4" data-aos="zoom-in" data-aos-delay="300">
                    <div class="admission-card">
                        <div class="admission-card_img"><img
                                src="{{ asset('asset_vitrine/assets/img/update1/normal/admission_1_9.jpg') }}"
                                alt="image"></div>
                        <div class="admission-card_content">
                            <h3 class="admission-card_title box-title">Esthétique et Cosmétiques</h3>
                            <p class="admission-card_text">Apprenez les techniques de soin de la peau, de maquillage et
                                de coiffure pour une carrière dans la beauté.</p>

                            <a href="{{ asset('ECOLE-DES-METIERS-DU-CAMEROUN-NDAZOA_esthétique.pdf') }}"
                                class="th-btn">Brochure</a> <br>

                            <a href="#" class="link-btn register-btn"
                                data-filiere="Esthétique et Cosmétiques">S'inscrire maintenant<i
                                    class="fas fa-arrow-right"></i></a>
                ...
                <div class="col-md-6 col-xl-4" data-aos="zoom-in" data-aos-delay="300">
                    <div class="admission-card">
                        <div class="admission-card_img"><img
                                src="{{ asset('asset_vitrine/assets/img/update1/normal/admission_1_10.jpg') }}"
                                alt="image"></div>
                        <div class="admission-card_content">
                            <h3 class="admission-card_title box-title">Énergies Renouvelables</h3>
                            <p class="admission-card_text">Développez des compétences en installation et maintenance de
                                systèmes solaires et éoliens durables.</p>
                            <a href="#" class="link-btn register-btn"
                                data-filiere="Énergies Renouvelables">S'inscrire maintenant<i
                                    class="fas fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-4" data-aos="zoom-in" data-aos-delay="300">
                    <div class="admission-card">
                        <div class="admission-card_img"><img
                                src="{{ asset('asset_vitrine/assets/img/update1/normal/admission_1_11.jpg') }}"
                                alt="image"></div>
                        <div class="admission-card_content">
                            <h3 class="admission-card_title box-title">Innovation et Technologies</h3>
                            <p class="admission-card_text">Explorez les nouvelles technologies comme l'IoT, la
                                robotique et l'intelligence artificielle pour innover.</p>
                            <a href="#" class="link-btn register-btn"
                                data-filiere="Innovation et Technologies">S'inscrire maintenant<i
                                    class="fas fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
    ...
    <section class="space" id="blog-sec" data-aos="fade-up" data-aos-duration="800">
        <div class="container">
            <div class="title-area text-center">
                ...
                <h2 class="sec-title fw-semibold">Nos publications récentes</h2>
            </div>
            <div class="row slider-shadow th-carousel" data-slide-show="2" data-lg-slide-show="2"
                    ...
                    <div class="blog-recent">
                        ...
                        <div class="blog-content">
                            <div class="blog-meta style2">
                                <a href="#"><i class="far fa-clock"></i>15 mars 2025</a>
                                <a href="#"><i class="far fa-user"></i>par Jean Mbarga</a>
                            </div>
                            <h3 class="blog-title">Comment maîtriser les bases de la mécanique automobile</h3>
                ...
                <div class="col-md-6 col-xl-6" data-aos="fade-up" data-aos-delay="200">
                    <div class="blog-recent">
                        ...
                        <div class="blog-content">
                            <div class="blog-meta style2">
                                <a href="#"><i class="far fa-clock"></i>16 mars 2025</a>
                                <a href="#"><i class="far fa-user"></i>par Marie Ngo</a>
                            </div>
                            <h3 class="blog-title">Conseils pour créer des vêtements uniques avec la couture</h3>
                            <a href="#" class="th-btn style4">Lire les détails<i
                                    class="fas fa-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-xl-6" data-aos="fade-up" data-aos-delay="300">
                    <div class="blog-recent">
                        <div class="blog-img"><img
                                src="{{ asset('asset_vitrine/assets/img/update1/blog/blog_5_3.jpg') }}"
                                alt="blog image"></div>
                        <div class="blog-content">
                            <div class="blog-meta style2">
                                <a href="#"><i class="far fa-clock"></i>17 mars 2025</a>
                                <a href="#"><i class="far fa-user"></i>par Paul Ekwé</a>
                            </div>
                            <h3 class="blog-title">Introduction à la programmation pour débutants</h3>
                            <a href="#" class="th-btn style4">Lire les détails<i
                                    class="fas fa-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                        ...
                        <div class="widget footer-widget style2">
                            <div class="th-widget-about">
                                <div class="about-logo">
                                    <a href="#"><img
                                            src="{{ asset('asset_vitrine/assets/img/logo-white.png') }}"
                                            alt="INSTITUT SUPERIEUR LA MAJESTUEUSE la Majestueuse"></a>
                                </div>
                                <p class="about-text">L’École de Métier Ndazoa offre des formations professionnelles
                                    bilingues pour préparer les étudiants à des carrières réussies dans divers métiers
                                    techniques et artisanaux.</p>
                                <div class="th-social">
                                    <a href="#"><i class="fab fa-facebook-f"></i></a>
                                    <a href="#"><i class="fab fa-twitter"></i></a>
                                    <a href="#"><i class="fab fa-linkedin-in"></i></a>
